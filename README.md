...
### 3. Настройка MCP server (для AI assistants)

Для интеграции с Claude Code или другими AI-ассистентами через MCP servers добавьте в конфиг:
...
npm start find agent-safe

# Найти с фильтром по доске
npm start find agent-safe --board=12345

# Получить детали задачи
npm start card-simple 12345

# Создать подзадачу
npm start subtask create 12345 "Настроить роутинг"

# Добавить комментарий о прогрессе
npm start comment add 12345 "Начал работу над роутингом"

# Переместить в другую колонку
npm start move 12345 67890
```
